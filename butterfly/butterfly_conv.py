...
from butterfly.butterfly_multiply import butterfly_mult_conv2d, bbt_mult_conv2d  #butterfly_mult_conv2d_svd
...
class ButterflyConv1d(ButterflyBmm):
    """Product of log N butterfly factors, each is a block 2x2 of diagonal matrices.
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1,
        ...
        super().__init__(in_channels, out_channels, kernel_size, complex=False, **kwargs)
    ...
    def forward(self, input):
        ...
        inp_unf = F.unfold(input, (1, self.kernel_size)) # (batch, kernel_size*c_in, l_out)
        ...
        input = inp_unf.reshape(batch * l_out, self.kernel_size, c_in)
        ...
        return output.view(batch, l_out, self.out_channels).transpose(1, 2)
